import { listPublishedClinicians } from '@/lib/cms'
import type { ClinicianProfile } from '@/lib/types'
...
export function CliniciansPage() {
  ...
  return (
    <div className="container-page py-14 sm:py-16">
      ...
      {loading ? (
        <p className="mt-10 text-sm text-ink-muted">Loading clinicians…</p>
      ) : (
